...
// Submit the prefix of the frame currently being recorded, rotate the mapped
// staging buffers, and resume recording without advancing the logical frame.
// The caller must not hold renderer_gpu_mutex() while invoking this function.
