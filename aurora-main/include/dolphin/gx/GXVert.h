...
// Host-only companion for a hardware GXAbortFrame.  This clears Aurora's
// incremental GXBegin/GXEnd bookkeeping without validating or submitting the
// incomplete primitive; the caller separately discards pending FIFO bytes.
extern void GXAbortPendingPrimitive(void);
