...
Three data sets from Dolphin's `Data/Sys` tree are redistributed here under GPL-2.0-or-later:
...
| `runtime/assets/ipl/font_japanese.bin`, `runtime/assets/ipl/font_western.bin` | `Data/Sys/GC/font_japanese.bin`, `Data/Sys/GC/font_western.bin` | Dolphin's free replacement IPL font assets, used by Wii/GameCube EXI font reads when no copyrighted IPL dump is supplied. SHA-256 `38F9F59D505BC4E2D86B0196706195F33AD72B7FE9D029CF263072CDE19D044F` and `4AD991BE2B0AA305F09B90A79FC50F57833B30B008890B5EF1336CC3D9D0BAE0`. |
...
included in the installer's `licenses/` folder. Release tooling may bundle the pinned source
trees so end-user builds can run offline.
...
> supply it on request for the exact version shipped in any given release.
...
Not code, but documentation used during development:
