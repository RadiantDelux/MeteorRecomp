...
inline uint32_t kDefaultThreadContextAddr = 0x80347498u;
inline uint32_t kIdleThreadContextAddr = 0x803478b0u;
inline uint32_t kThreadQueueArrayAddr = 0x803477b0u;
constexpr size_t kThreadQueueArrayBytes = 0x100u;
inline uint32_t kSwitchThreadCallbackPtrAddr = 0x80385ae0u;
inline uint32_t kSchedulerReschedCounterAddr = 0x8038691cu;
inline uint32_t kSchedulerPendingFlagAddr = 0x80386920u;
...
inline uint32_t kSchedulerIdleFlagAddr = 0x80386918u;
inline uint32_t kOSInitContextFunctionAddr = 0x801A20BCu;
inline uint32_t kOSExitThreadFunctionAddr = 0x801AA0F0u;
inline uint32_t kSchedulerInitFlagAddr = 0x80347130u;
inline uint32_t kThreadAttrSourceAddr = 0x80385AA8u;
inline uint32_t kAlarmQueueOffsetFromR13 = 0x6360u;
inline uint32_t kAlarmInsertFunctionAddr = 0x801A0620u;
