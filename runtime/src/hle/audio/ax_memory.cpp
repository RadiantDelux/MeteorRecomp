...
uint32_t g_dspInitializedAddr = 0x80386608u;
uint32_t g_dspAssertPendingAddr = 0x80386610u;
uint32_t g_dspAssertTaskAddr = 0x80386614u;
uint32_t g_dspReservedStateAddr = 0x80386618u;
uint32_t g_dspCurrentTaskAddr = 0x8038661Cu;
uint32_t g_dspFirstTaskAddr = 0x80386620u;
uint32_t g_dspRunningTaskAddr = 0x80386624u;
...
void MarkDspInitialized() {
    Memory::TryWrite32(g_dspInitializedAddr, 1);
}

void ResetDspTaskGlobals() {
    Memory::TryWrite32(g_dspAssertPendingAddr, 0);
    Memory::TryWrite32(g_dspAssertTaskAddr, 0);
    Memory::TryWrite32(g_dspReservedStateAddr, 0);
    Memory::TryWrite32(g_dspCurrentTaskAddr, 0);
    Memory::TryWrite32(g_dspFirstTaskAddr, 0);
    Memory::TryWrite32(g_dspRunningTaskAddr, 0);
}
...
void LinkSingleDspTask(uint32_t taskPtr) {
    ...
    Memory::TryWrite32(g_dspFirstTaskAddr, taskPtr);
...
#if WIICOMPILED_GUEST_IS_GAMECUBE
    return Memory::GetGameCubeAramPointer()[addr & 0x00ffffffu];
#else
