...
/// <summary>
/// Entry facts for a dynamic-module template function. These are deliberately
/// separate from <see cref="CxxBuildRegistrationFacts"/> because the canonical
/// template address must never enter the fixed translated-function registry.
/// </summary>
public sealed record CxxDynamicDispatchFacts(
    string Symbol,
    bool PreserveNonvolatileGprs,
    uint NonvolatileFprWriteMask);
